...
import (
	...
	v1alpha1 "github.com/yunify/hostnic-cni/pkg/client/listers/vxnetpool/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VxnetpoolV1alpha1().VxNetPools().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VxnetpoolV1alpha1().VxNetPools().Watch(context.TODO(), options)
			},
		},
		&vxnetpoolv1alpha1.VxNetPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vxNetPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vxnetpoolv1alpha1.VxNetPool{}, f.defaultInformer)
}
