...
import (
	...
	vxnetpool "github.com/yunify/hostnic-cni/pkg/client/informers/externalversions/vxnetpool"
...
func (f *sharedInformerFactory) Vxnetpool() vxnetpool.Interface {
	return vxnetpool.New(f, f.namespace, f.tweakListOptions)
}
